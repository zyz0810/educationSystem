<template>
  <my-dialog :visible="dialogVisible"
    ...
    <pagination v-show="total > 0"
                ...
                @pagination="queryWebDetailByDept"
                class="text-right" />
...
<script>
import { queryWebDetailByDept } from "@/api/statistics";
export default {
  props: {
    showDialog: {
      required: true,
  ...
  methods: {
    queryWebDetailByDept () {
      this.listLoading = true;
      queryWebDetailByDept(this.listQuery)
        .then(res => {
