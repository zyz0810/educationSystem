  ...
  <div>
    <el-form :inline="true"
      ...
      <!-- <el-form-item label="选择人员">
        <el-select v-model="listQuery.clerkId" @change="query" placeholder="选择人员" clearable>
...
export default {
  ...
  mounted () {
    ...
    Object.assign(this.listQuery, {
      endTime: this.$moment(endTime).format("YYYY-MM-DD 00:00:00"),
      startTime: this.$moment(startTime).format("YYYY-MM-DD 23:59:59")
    });
    this.findDeptTree();
    this.getUsers();
