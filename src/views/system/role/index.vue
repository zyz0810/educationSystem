  ...
  <div class="app-container">
    <el-form :model="queryParams"
      ...
      <el-form-item label="角色名称"
                    prop="roleName">
        <el-input v-model.trim="queryParams.roleName"
                  placeholder="请输入角色名称"
                  clearable
                  size="small"
                  style="width: 240px"
      ...
      <el-form-item label="权限字符"
                    prop="roleKey">
        <el-input v-model.trim="queryParams.roleKey"
                  placeholder="请输入权限字符"
                  clearable
                  size="small"
                  style="width: 240px"
    ...
    <my-dialog :title="title"
      ...
      <el-form ref="form"
        ...
        <el-form-item label="权限字符"
                      prop="roleKey">
          <el-input v-model.trim="form.roleKey"
                    placeholder="请输入权限字符" />
        </el-form-item>
        <el-form-item label="角色顺序"
                      prop="roleSort">
          <el-input-number v-model.trim="form.roleSort"
